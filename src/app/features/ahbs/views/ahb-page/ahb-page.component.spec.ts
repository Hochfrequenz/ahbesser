...
describe('AhbPageComponent', () => {
  ...
  it('should handle empty direction', () => {
    ...
    expect(result.sender).toBe('MSCONS-Nachrichten können von verschiedenen Marktrollen gesendet werden.');
    expect(result.empfaenger).toBe('MSCONS-Nachrichten können von verschiedenen Marktrollen empfangen werden.');
  });
